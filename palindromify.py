...
# add three letters to it (which is the smallest amount to make a palindrome). There
# are seven other palindromes that can be made from "race" by adding three letters,
