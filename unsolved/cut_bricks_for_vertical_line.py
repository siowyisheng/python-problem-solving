...
uniform height. Your goal is to find a vertical line going from the top to the
bottom of the wall that cuts through the fewest number of bricks. If the line
goes through the edge between two bricks, this does not count as a cut.
...
represent the lengths of bricks in that row:
    ...
    above, return the fewest number of bricks that must be cut to create
    a vertical line.
